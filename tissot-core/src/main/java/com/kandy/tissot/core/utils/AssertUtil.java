...
/**
 * Created by bjkandy on 2016/1/8.
 */
public abstract class AssertUtil extends Assert {
    public static void isTrue(boolean expression, String message) {
        if (!expression) {
            throw new ServiceException(ErrorCodeEnum.参数异常.getCode(),message);
        }
    }
    ...
    public static void isNull(Object object, String message) {
        if (object != null) {
            throw new ServiceException(ErrorCodeEnum.参数不为空.getCode(),message);
        }
    }
