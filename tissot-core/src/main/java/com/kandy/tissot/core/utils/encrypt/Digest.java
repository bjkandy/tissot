package com.kandy.tissot.core.utils.encrypt;

import com.kandy.tissot.core.utils.ConvertUtil;
...
public class Digest {
	...
	public static String signMD5(String aValue, String encoding) {
		try {
			...
			return ConvertUtil.toHex(md.digest(input));
	...
	public static String digest(String aValue, String encoding) {
		...
		return ConvertUtil.toHex(md.digest(value));
	}
